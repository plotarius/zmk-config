...
[[ -z $HOST_ZMK_DIR ]] && HOST_ZMK_DIR="$HOME/projects/zmk"
...
then
    ...
    # Build parameters
    DOCKER_PREFIX="$DOCKER_CMD -w $DOCKER_ZMK_DIR $DOCKER_IMG"
...
echo $DOCKER_PREFIX west build -d "build/$BUILD_DIR" -b $1 $WEST_OPTS \
